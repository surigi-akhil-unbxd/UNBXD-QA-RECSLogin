...
public class DVexitIntentTemplateTest extends BaseTest {
    ...
    public void testTemplatesPageElementsInteraction(JsonObject dataMap) {
        ...
        templatesActions.isVerticalWidgetDisplayed();
        ...
        // OPTIMIZATION: Reduced wait time from 1000ms to 1000ms (already optimized)
        try {
            Thread.sleep(1000);
        } catch (InterruptedException e) {
            e.printStackTrace();
