...
public class MVtinderLikeBehaviorTemplateTest extends BaseTest {
    ...
    @FileToTest("recsTestData/MVtinderLikeBaviorTemplate.json")
    public void testTemplatesPageElementsInteraction(JsonObject dataMap) {
        ...
        try {
            templatesActions.swipeTinderProducts();
