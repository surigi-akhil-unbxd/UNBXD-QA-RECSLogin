...
public class MVboutiqueTemplateTest extends BaseTest {
    ...
    @FileToTest("recsTestData/MVboutiqueTemplateTestData.json")
    public void testTemplatesPageElementsInteraction(JsonObject dataMap) {
        ...
        try {
            Thread.sleep(3000); // Wait for 3 seconds after clicking Demo Preview
