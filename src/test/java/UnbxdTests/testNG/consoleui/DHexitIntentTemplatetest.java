...
public class DHexitIntentTemplatetest extends BaseTest {
    ...
    @FileToTest("recsTestData/DHexitintentTemplatesTestData.json")
    public void testTemplatesPageElementsInteraction(JsonObject dataMap) {
        ...
        // Click widget size dropdown and enter widget size from test data
